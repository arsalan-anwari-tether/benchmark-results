...
````bash
/data/data/com.termux/files/home/qvac-fabric-llm.cpp/build/bin/llama-cli -m /data/data/com.termux/files/home/models/Qwen3-4B-Q4_K_M.gguf --jinja --reasoning-budget 0 -ngl 999 -st -p \<prompt\> -n 512 --temp 0.2 --top-k 20 --top-p 0.9 --min-p 0 --repeat-penalty 1.05 --presence-penalty 0.0  </dev/null
````
...
main: enable_thinking (chat template) = 0
sampler seed: 1592318393
sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.050, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 4096
	top_k = 20, top_p = 0.900, min_p = 0.000, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.200
