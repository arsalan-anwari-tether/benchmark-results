...
````bash
/data/data/com.termux/files/home/qvac-fabric-llm.cpp/build/bin/llama-cli -m models/custom/Qwen3-4B-Q4_K_M.gguf --jinja --device none --reasoning-budget 0 -ngl 0 -st -p \<prompt\> -n 512 --temp 0.2 --top-k 20 --top-p 0.9 --min-p 0 --repeat-penalty 1.05 --presence-penalty 0.0  </dev/null
````
...
- If they are the same, the string is a
